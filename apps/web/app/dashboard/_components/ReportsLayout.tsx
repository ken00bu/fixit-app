...
export default function ReportsLayout({ statistic, setStatistic, error }: { statistic: Statistic; setStatistic: React.Dispatch<React.SetStateAction<Statistic>>; error: boolean }) {
    ...
    if (!reports || !statistic) return null
    ...
    return (
        <Flex direction={'column'} gap={30}>
            ...
            <Flex gap={{ base: 10, sm: 30 }} direction={{ base: 'column', sm: 'row' }} wrap='wrap'>
                <ReportsList reports={reports} setStatistic={setStatistic} setReports={setReports} page={page} refresh={reportRefresh} />
            </Flex>
